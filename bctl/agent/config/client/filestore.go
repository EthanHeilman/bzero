...
func NewFileStore(configDir string, configType ConfigType) (*fileStore, error) {
...
func (s *fileStore) FetchAgentData() (agentdata.AgentDataV2, error) {
...
func (s *fileStore) FetchKeyShardData() (ksdata.KeyShardData, error) {
...
func (s *fileStore) Save(d interface{}) error {
...
func (s *fileStore) WaitForRegistration(ctx context.Context) error {
